...
lib.ssMetadata = [
		{name:"TARJETA WEB_HTML5 Canvas_atlas_1", frames: [[1186,117,65,115],[1186,0,90,115],[0,0,591,1004],[593,0,591,1004]]}
];
...
p.nominalBounds = new cjs.Rectangle(0,0,32.5,57.5);
...
p.nominalBounds = new cjs.Rectangle(0,0,45,57.5);
...
if (reversed == null) { reversed = false; }
	...
	// Capa_1
	this.button_3 = new lib.Símbolo4();
	this.button_3.name = "button_3";
	this.button_3.setTransform(1.35,0,1,1,0,0,0,16.2,28.8);
	new cjs.ButtonHelper(this.button_3, 0, 1, 1);

	this.button_4 = new lib.Símbolo6();
	this.button_4.name = "button_4";
	this.button_4.setTransform(0.05,0.1,1,1,0,0,0,19.9,19.9);
	new cjs.ButtonHelper(this.button_4, 0, 1, 1);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.button_4},{t:this.button_3}]}).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.Símbolo8, new cjs.Rectangle(-19.8,-28.8,39.7,57.5), null);
...
}).prototype = getMCSymbolPrototype(lib.Símbolo7, new cjs.Rectangle(-25,-28.8,50,57.5), null);
...
if (reversed == null) { reversed = false; }
	...
	this.instance_1.setTransform(0,0,0.1692,0.1692);
	...
	this.movieClip_6.setTransform(125,84.8);

	this.movieClip_7 = new lib.Símbolo8();
	this.movieClip_7.name = "movieClip_7";
	this.movieClip_7.setTransform(119.85,84.8);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.movieClip_6}]}).to({state:[{t:this.movieClip_7}]},12).wait(12));

	this._renderFirstFrame();

}).prototype = p = new lib.AnMovieClip();
p.nominalBounds = new cjs.Rectangle(75,84.5,75,85.4);
// library properties:
lib.properties = {
